        ...
        <div class="mx-6 my-4 flex flex-col">
            ...
            <div class="w-full rounded shadow-lg my-2 border">
                <div class="flex-col justify-center items-center m-4">
                    ...
                    <a href="{{route('event.editWorker', ['event' => $event])}}" class="flex flex-row justify-center items-center mt-4 p-2 font-mediu border border-2 rounded-full w-full hover:border-mypink-light hover:text-mypink-light">
