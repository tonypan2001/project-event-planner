            ...
            <div id="main" class="flex flex-col justify-center items-center mt-10">
                <div id="info" class="w-full grid grid-cols-2 gap-2 p-4 rounded shadow-lg my-2 border bg-gray-100">
                    <div class="w-full rounded shadow-lg my-2 border bg-zinc-300 p-4">
                        <p class="w-full mb-2 text-xl font-medium text-left font-extrabold">Used</p>
                        <p class="mb-2 text-xl font-medium text-left font-bold">10000 Bath</p>
                    </div>
                    <div class="w-full rounded shadow-lg my-2 border bg-zinc-300 p-4">
                        <p class="mb-2 text-xl font-medium text-left font-extrabold">Total Budget</p>
                        <p class="mb-2 text-xl font-medium text-left font-bold">50000 Bath</p>
                    </div>
                </div>
                ...
                <div id="inputBlockContainer" class="w-full rounded shadow-lg my-2 border bg-zinc-300">
                    <div class="grid grid-cols-2 gap-4 p-4">
                        <div>
                            ...
                            <input type="text" class="w-full p-2 border rounded-md focus:outline-none focus:ring-2 focus:ring-mypink-light" value="โต๊ะไม้ขนาด 5 เมตร" placeholder="Enter name">
                        </div>
                        <div>
                            <p class="mb-2 text-m font-medium">Amount</p>
                            <input type="text" class="w-full p-2 border rounded-md focus:outline-none focus:ring-2 focus:ring-mypink-light" value="10000" placeholder="Enter amount">
                        </div>
                    </div>
                </div>
    ...
    <script>
        ...
        addInputBlockButton.addEventListener('click', () => {
            ...
            newInputBlock.innerHTML = `
                ...
                <div>
                    <input type="text" class="w-full p-2 border rounded-md focus:outline-none focus:ring-2 focus:ring-mypink-light" placeholder="Enter amount">
                </div>
            `;
