        ...
        <div class="mx-6 my-4 flex flex-col">
            <div class="w-full shadow-xl bg-white rounded-xl my-1">
                ...
                <div class="flex content-center justify-between w-full mb-5 mx-6">
                    <a href="{{ url()->previous() }}" class="w-full">< Back</a>
                    <button class="w-full bg-mypink-light hover:bg-mypink-dark text-white font-bold py-2 px-10 rounded-full">Save</button>
