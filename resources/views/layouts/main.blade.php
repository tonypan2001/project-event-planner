...
{{--             Real SIDEBAR --}}
            <div id="sidebar" class="flex h-screen left-auto px-12 pt-4 fixed top-0 transform duration-300" style="background: rgb(150,1,218);
                ...
                <div class="flex flex-col justify-up items-center text-center text-white mt-12">
                    ...
                    <a href="{{route('settings.update',[Auth::user()->id])}}" class="flex flex-row justify-center items-center mt-4 p-2 font-mediu border border-2 rounded-full w-full hover:border-mypink-light hover:text-mypink-light">
